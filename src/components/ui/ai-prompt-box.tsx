...
import { ArrowUp, Paperclip, Square, X, StopCircle, Send, BrainCog, FolderCode } from "lucide-react";
...
const CustomDivider: React.FC = () => (
  <div className="relative h-6 w-[1.5px] mx-1">
    <div
      className="absolute inset-0 bg-gradient-to-t from-transparent via-red-500/70 to-transparent rounded-full"
      style={{
...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  const { onSend = () => {}, isLoading = false, placeholder = "Type your response here...", className } = props;
